...
# indicate the type of model used (fixed vs. random). 

# Inputs:
# data_location - filepath for the trial-level data being loaded into the function for
# model fitting. 
# NOTE: Needs specification, no default. Input data needs to be in wide format
# (ex. clinical event metrics are in separate columns, labeled in column names)
...
trial_MR = function(data_location,data_file,output_location,model_number=1,
  ...
  colnames(model.info)=c("posteriors_saved_file","trial_data_used","pooled","outcome_SE_Cutoff",
                         ...
                         "variable_smallest_ESS","smallest_ESS", "ESS_meta-reg_Slope_1","ESS_meta-reg_slope_2","ESS_meta-reg_ERRSD","ESS_meta-reg_intercept",
...
#                 num.iter=1000,model_number = 1,fit_date = "May-2022",num_chains=3,indep_var_name_est="beta31_beta32_est",
...
#                 model_type="random",
#                 num.iter=500,model_number = 2,fit_date = "aug25-2021",num_chains=1,indep_var_name_est="beta31_beta32_est",
#                 indep_var_name_se = "beta31_beta32_se",outcome_name_est = "loghr1_est",outcome_name_se = "loghr1_se",
