...
libname results "&path1\analysis_sets\trunc18\models\results";
libname temp "&path1\analysis_sets\trunc18\models\temp";
libname temp2 "&path1\analysis_sets\trunc18\models\temp2";
...
_Log_ACR_=NO,_Acute_GFR_=NO,_QUAD_=NO,_TRUNC_=YES,_TRUNCATE_=21);
%doall(1);
