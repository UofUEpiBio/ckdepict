...
run;
data bstudies;
 set SASdata.allrxdata_acr6;
run;
data cstudies;
 set SASdata.b_gfr_up_6m;
...
data sall2;
 ...
 drop var_order;
run;
%zexportcsv(sall2,txt_effects_up2,&path1\analysis_sets\acr6\exports);

%zexportcsv(sall2,txt_effects_up2,&path1\analysis_sets\acr6\datasets);
...
data zzsall2;
 ...
 drop var_order;
run;
%zexportcsv(zzsall2,txt_effects_up2a,&path1\analysis_sets\acr6\exports);

%zexportcsv(zzsall2,txt_effects_up2a,&path1\analysis_sets\acr6\datasets);
...
data xsall2;
 ...
 drop var_order;
run;
%zexportcsv(xsall2,noint_txt_effects_up2,&path1\analysis_sets\acr6\exports);

%zexportcsv(xsall2,noint_txt_effects_up2,&path1\analysis_sets\acr6\datasets);
