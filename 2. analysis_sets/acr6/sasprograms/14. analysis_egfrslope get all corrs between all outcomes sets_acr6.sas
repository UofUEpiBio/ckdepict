...
libname Results  "&path1\analysis_sets\acr6\correlations\results";
...
data Exports.allcorr;
 set allcorr;
run;
%zexportcsv(allcorr,allcorr,&path1\analysis_sets\acr6\exports);

data SASdata.allcorr;
 set allcorr;
run;
%zexportcsv(allcorr,allcorr,&path1\analysis_sets\acr6\datasets);
