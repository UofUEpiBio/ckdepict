...
data t99;
 ...
 keep allrx allrxname allrxname1 study beta31_beta32_est beta31_beta32_se beta31_beta32_sem beta31_beta32_sem npatients	nevents region 
	  ...
	  beta21_beta22_est beta21_beta22_se beta21_beta22_sem beta21_beta22_sem
	  beta21_est beta21_se beta21_sem beta21_sem beta22_est beta22_se beta22_sem beta22_sem
...
data t99_quad;
 ...
 set t99_quad2;
run;
data Exports.t99_quad;
 set t99_quad;
run;
%zexportcsv(t99_quad,t99_quad,&path1\analysis_sets\quad\Exports);

data SASdata.t99_quad;
 set t99_quad;
run;
%zexportcsv(t99_quad,t99_quad,&path1\analysis_sets\quad\Datasets);
