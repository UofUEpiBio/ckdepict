if compress(UP_MeasureToUse)="PER" then do;
	...
	if .<base_24_upro_tot<30 then zup30=0;
	else if base_24_upro_tot>=30 then zup30=1;
	if .<base_24_upro_tot<100 then zup100=0;
	else if base_24_upro_tot>=100 then zup100=1;
 end;
 if compress(UP_MeasureToUse)="AER" then do;
	...
	if .<base_24_ualb_tot<30 then zup30=0;
	else if base_24_ualb_tot>=30 then zup30=1;
	if .<base_24_ualb_tot<100 then zup100=0;
	else if base_24_ualb_tot>=100 then zup100=1;
 end;
 if compress(UP_MeasureToUse)="PCR" then do;
	...
	if .<base_24_upro_rat<30 then zup30=0;
	else if base_24_upro_rat>=30 then zup30=1;
	if .<base_24_upro_rat<100 then zup100=0;
	else if base_24_upro_rat>=100 then zup100=1;
 end;
 if compress(UP_MeasureToUse)="ACR" then do;
	...
	if .<base_24_ualb_rat<30 then zup30=0;
	else if base_24_ualb_rat>=30 then zup30=1;
	if .<base_24_ualb_rat<100 then zup100=0;
	else if base_24_ualb_rat>=100 then zup100=1;
end;
 if compress(UP_MeasureToUse)="SPCR" then do;
	...
	if .<base_spot_upro_rat<30 then zup30=0;
	else if base_spot_upro_rat>=30 then zup30=1;
	if .<base_spot_upro_rat<100 then zup100=0;
	else if base_spot_upro_rat>=100 then zup100=1;
 end;
 if compress(UP_MeasureToUse)="SACR" then do;
	...
	if .<base_spot_ualb_rat<30 then zup30=0;
	else if base_spot_ualb_rat>=30 then zup30=1;
	if .<base_spot_ualb_rat<100 then zup100=0;
	else if base_spot_ualb_rat>=100 then zup100=1;
 end;
