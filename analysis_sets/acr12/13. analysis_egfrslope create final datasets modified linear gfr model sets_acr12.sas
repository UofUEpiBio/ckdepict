...
data est_out4_1y;
 set est_out;
 if label in ("beta41 at t=12 Months" "beta42 at t=12 Months" "beta42 - beta41 at t=12 Months");
 if label in ("beta41 at t=12 Months")  then label="beta41_1y";
 if label in ("beta42 at t=12 Months")  then label="beta42_1y";
...
proc sort data=est_out4_1y;
 by study model surv sp prop pom psi21_used;
run;
proc transpose data=est_out4_1y out=est_out4a_1y(drop=_name_) let suffix=_est;
 by study model surv sp prop pom psi21_used;
 var est;
 id label;
run;
proc transpose data=est_out4_1y out=est_out4b_1y(drop=_name_) let suffix=_se;
 by study model surv sp prop pom psi21_used;
 var se;
 id label;
run;
proc transpose data=est_out4_1y out=est_out4c_1y(drop=_name_) let suffix=_sem;
 by study model surv sp prop pom psi21_used;
 var sem;
 id label;
run;
proc transpose data=est_out4_1y out=est_out4d_1y(drop=_name_) let suffix=_see;
 by study model surv sp prop pom psi21_used;
 var see;
 id label;
run;
...
data est_out4_2y;
 set est_out;
 if label in ("beta41 at t=24 Months" "beta42 at t=24 Months" "beta42 - beta41 at t=24 Months");
 if label in ("beta41 at t=24 Months")  then label="beta41_2y";
 if label in ("beta42 at t=24 Months")  then label="beta42_2y";
...
proc sort data=est_out4_2y;
 by study model surv sp prop pom psi21_used;
run;
proc transpose data=est_out4_2y out=est_out4a_2y(drop=_name_) let suffix=_est;
 by study model surv sp prop pom psi21_used;
 var est;
 id label;
run;
proc transpose data=est_out4_2y out=est_out4b_2y(drop=_name_) let suffix=_se;
 by study model surv sp prop pom psi21_used;
 var se;
 id label;
run;
proc transpose data=est_out4_2y out=est_out4c_2y(drop=_name_) let suffix=_sem;
 by study model surv sp prop pom psi21_used;
 var sem;
 id label;
run;
proc transpose data=est_out4_2y out=est_out4d_2y(drop=_name_) let suffix=_see;
 by study model surv sp prop pom psi21_used;
 var see;
 id label;
run;
...
data est_out4_3y;
 set est_out;
 if label in ("beta41 at t=36 Months" "beta42 at t=36 Months" "beta42 - beta41 at t=36 Months");
 if label in ("beta41 at t=36 Months")  then label="beta41_3y";
 if label in ("beta42 at t=36 Months")  then label="beta42_3y";
...
proc sort data=est_out4_3y;
 by study model surv sp prop pom psi21_used;
run;
proc transpose data=est_out4_3y out=est_out4a_3y(drop=_name_) let suffix=_est;
 by study model surv sp prop pom psi21_used;
 var est;
 id label;
run;
proc transpose data=est_out4_3y out=est_out4b_3y(drop=_name_) let suffix=_se;
 by study model surv sp prop pom psi21_used;
 var se;
 id label;
run;
proc transpose data=est_out4_3y out=est_out4c_3y(drop=_name_) let suffix=_sem;
 by study model surv sp prop pom psi21_used;
 var sem;
 id label;
run;
proc transpose data=est_out4_3y out=est_out4d_3y(drop=_name_) let suffix=_see;
 by study model surv sp prop pom psi21_used;
 var see;
 id label;
run;
...
data est_out4_4y;
 set est_out;
 if label in ("beta41 at t=48 Months" "beta42 at t=48 Months" "beta42 - beta41 at t=48 Months");
 if label in ("beta41 at t=48 Months")  then label="beta41_4y";
 if label in ("beta42 at t=48 Months")  then label="beta42_4y";
...
proc sort data=est_out4_4y;
 by study model surv sp prop pom psi21_used;
run;
proc transpose data=est_out4_4y out=est_out4a_4y(drop=_name_) let suffix=_est;
 by study model surv sp prop pom psi21_used;
 var est;
 id label;
run;
proc transpose data=est_out4_4y out=est_out4b_4y(drop=_name_) let suffix=_se;
 by study model surv sp prop pom psi21_used;
 var se;
 id label;
run;
proc transpose data=est_out4_4y out=est_out4c_4y(drop=_name_) let suffix=_sem;
 by study model surv sp prop pom psi21_used;
 var sem;
 id label;
run;
proc transpose data=est_out4_4y out=est_out4d_4y(drop=_name_) let suffix=_see;
 by study model surv sp prop pom psi21_used;
 var see;
 id label;
run;
...
data chronic_total_diff;
 set est_out;
 if label in ("(beta42 - beta41) - (beta12 - beta11) at year 1" 
              "(beta42 - beta41) - (beta12 - beta11) at year 2"
              "(beta42 - beta41) - (beta12 - beta11) at year 3"
              "(beta42 - beta41) - (beta12 - beta11) at year 4");
 if label in ("(beta42 - beta41) - (beta12 - beta11) at year 1")  then label="chronic_t1y";
 if label in ("(beta42 - beta41) - (beta12 - beta11) at year 2")  then label="chronic_t2y";
 if label in ("(beta42 - beta41) - (beta12 - beta11) at year 3")  then label="chronic_t3y";
 if label in ("(beta42 - beta41) - (beta12 - beta11) at year 4")  then label="chronic_t4y";
 est=estimate;
 if StandardError ne . then se=StandardError;else se=RobustStandardError;
 sem=StandardError;
 see=RobustStandardError;
...
proc sort data=chronic_total_diff;
 by study model surv sp prop pom psi21_used;
run;
proc transpose data=chronic_total_diff out=chronic_total_diffa(drop=_name_) let suffix=_est;
 by study model surv sp prop pom psi21_used;
 var est;
 id label;
run;
proc transpose data=chronic_total_diff out=chronic_total_diffb(drop=_name_) let suffix=_se;
 by study model surv sp prop pom psi21_used;
 var se;
 id label;
run;
proc transpose data=chronic_total_diff out=chronic_total_diffc(drop=_name_) let suffix=_sem;
 by study model surv sp prop pom psi21_used;
 var sem;
 id label;
run;
proc transpose data=chronic_total_diff out=chronic_total_diffd(drop=_name_) let suffix=_see;
 by study model surv sp prop pom psi21_used;
 var see;
 id label;
run;
...
run;
%zexportcsv(xzall_models_t99,nfirstmodelinseqperstudyt99,&path1\analysis_sets\acr12\datasets);
%zexportxls(xzall_models_t99,nfirstmodelinseqperstudyt99,&path1\analysis_sets\acr12\datasets);
%zexportxlsx2007(xzall_models_t99,nfirstmodelinseqperstudyt99,&path1\analysis_sets\acr12\datasets);
data SASdata.nfirstmodelinseqperstudyt99;
 set xzall_models_t99;
run;
%zexportcsv(xzall_models_t99,nfirstmodelinseqperstudyt99,&path1\analysis_sets\acr12\exports);
%zexportxls(xzall_models_t99,nfirstmodelinseqperstudyt99,&path1\analysis_sets\acr12\exports);
%zexportxlsx2007(xzall_models_t99,nfirstmodelinseqperstudyt99,&path1\analysis_sets\acr12\exports);
