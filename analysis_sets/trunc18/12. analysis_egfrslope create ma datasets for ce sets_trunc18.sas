...
run;
proc sort data=ce_t99_trunc18_ma;
 by eventnumber zallrx;
run;
data SASdata.ce_t99_trunc18_ma;
 set ce_t99_trunc18_ma;
run;
%zexportcsv(ce_t99_trunc18_ma,ce_t99_trunc18_ma,&path1\analysis_sets\trunc18\Datasets);

data Exports.ce_t99_trunc18_ma;
 set ce_t99_trunc18_ma;
run;
%zexportcsv(ce_t99_trunc18_ma,ce_t99_trunc18_ma,&path1\analysis_sets\trunc18\Exports);
