...
run;
data all_slopes;
 merge acute3 acute slopes_linear;
 by study model surv sp prop pom psi21_used;
run;
...
run;
%zexportcsv(xzall_models_t99,nfirstmodelinseqperstudyt99,&path1\analysis_sets\trunc24\datasets);
data SASdata.nfirstmodelinseqperstudyt99;
 set xzall_models_t99;
run;
%zexportcsv(xzall_models_t99,nfirstmodelinseqperstudyt99,&path1\analysis_sets\trunc24\exports);
