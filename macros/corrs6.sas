%macro corrs6(lib,start,stop,out);
data xcorr;
study=0;
allrx=0;
eventnumber=0;
...
beta4_up6_3y_corr=0;
beta4_up6_4y_corr=0;
chronic_t1y_up6_corr=0;
chronic_t2y_up6_corr=0;
chronic_t3y_up6_corr=0;
chronic_t4y_up6_corr=0;
corr6_reason="                                                           ";
hess6_reason="                                                           ";
run;
%do i=&start %to &stop;
...
data cs;
 set &lib..cs&i;
 corr6_reason=reason;
 hess6_reason=hessian;
 keep study corr6_reason hess6_reason;
run;
data temp1;
 set &lib..cor&i;
run;
...
data acute_up6;
 ...
 beta1_up6_corr=corr&rowacute;
 keep study allrx beta1_up6_corr;
run;
%if %obsnumber(acute_up6)=0 %then %do;
data acute_up6;
 study=&i;
 beta1_up6_corr=.;
run;
...
data chronic_up6;
 set temp2;
 if label in ("trtment effect in ACR change");
 beta3_up6_corr=corr&rowchronic;
 keep study allrx beta3_up6_corr;
run;
%if %obsnumber(chronic_up6)=0 %then %do;
data chronic_up6;
 study=&i;
 beta3_up6_corr=.;
run;
...
data t1y_up6;
 set temp2;
 if label in ("trtment effect in ACR change");
 beta4_up6_1y_corr=corr&rowt1y;
 keep study allrx beta4_up6_1y_corr;
run;
%if %obsnumber(t1y_up6)=0 %then %do;
data t1y_up6;
 study=&i;
 beta4_up6_1y_corr=.;
run;
...
data t2y_up6;
 set temp2;
 if label in ("trtment effect in ACR change");
 beta4_up6_2y_corr=corr&rowt2y;
 keep study allrx beta4_up6_2y_corr;
run;
%if %obsnumber(t2y_up6)=0 %then %do;
data t2y_up6;
 study=&i;
 beta4_up6_2y_corr=.;
run;
...
data t3y_up6;
 set temp2;
 if label in ("trtment effect in ACR change");
 beta4_up6_3y_corr=corr&rowt3y;
 keep study allrx beta4_up6_3y_corr;
run;
%if %obsnumber(t3y_up6)=0 %then %do;
data t3y_up6;
 study=&i;
 beta4_up6_3y_corr=.;
run;
...
data t4y_up6;
 set temp2;
 if label in ("trtment effect in ACR change");
 beta4_up6_4y_corr=corr&rowt4y;
 keep study allrx beta4_up6_4y_corr;
run;
%if %obsnumber(t4y_up6)=0 %then %do;
data t4y_up6;
 study=&i;
 beta4_up6_4y_corr=.;
run;
...
data ct1y_up6;
 set temp2;
 if label in ("trtment effect in ACR change");
 chronic_t1y_up6_corr=corr&rowct1y;
 keep study allrx chronic_t1y_up6_corr;
run;
%if %obsnumber(ct1y_up6)=0 %then %do;
data ct1y_up6;
 study=&i;
 chronic_t1y_up6_corr=.;
run;
%end;
/** Chronic - Total 2y **/
data ct2y_row;
...
data ct2y_up6;
 set temp2;
 if label in ("trtment effect in ACR change");
 chronic_t2y_up6_corr=corr&rowct2y;
 keep study allrx chronic_t2y_up6_corr;
run;
%if %obsnumber(ct2y_up6)=0 %then %do;
data ct2y_up6;
 study=&i;
 chronic_t2y_up6_corr=.;
run;
%end;
/** Chronic - Total 3y **/
data ct3y_row;
...
data ct3y_up6;
 set temp2;
 if label in ("trtment effect in ACR change");
 chronic_t3y_up6_corr=corr&rowct3y;
 keep study allrx chronic_t3y_up6_corr;
run;
%if %obsnumber(ct3y_up6)=0 %then %do;
data ct3y_up6;
 study=&i;
 chronic_t3y_up6_corr=.;
run;
%end;
/** Chronic - Total 4y **/
data ct4y_row;
...
data ct4y_up6;
 set temp2;
 if label in ("trtment effect in ACR change");
 chronic_t4y_up6_corr=corr&rowct4y;
 keep study allrx chronic_t4y_up6_corr;
run;
%if %obsnumber(ct4y_up6)=0 %then %do;
data ct4y_up6;
 study=&i;
 chronic_t4y_up6_corr=.;
run;
%end;
/** up6 **/
data up6_row;
...
data up6;
 set temp2;
  ...
  up6_ce_corr=corr&rowup6;
  if eventnumber=. then delete;
  keep study allrx eventnumber up6_ce_corr;
run;
%if %obsnumber(up6)=0 %then %do;
data up6;
 do eventnumber=1 to 9 by 1;
 study=&i;
 up6_ce_corr=.;
...
run;
data corr;
 merge acute chronic t1y t2y t3y t4y ct1y ct2y ct3y ct4y up6;
 by study eventnumber;
run;
proc sort data=corr;
 by study;
run;
proc sort data=acute_up6;
 by study;
run;
proc sort data=chronic_up6;
 by study;
run;
proc sort data=t1y_up6;
 by study;
run;
proc sort data=t2y_up6;
 by study;
run;
proc sort data=t3y_up6;
 by study;
run;
proc sort data=t4y_up6;
 by study;
run;
proc sort data=ct1y_up6;
 by study;
run;
proc sort data=ct2y_up6;
 by study;
run;
proc sort data=ct3y_up6;
 by study;
run;
proc sort data=ct4y_up6;
 by study;
run;
proc sort data=cs;
 by study;
run;
data corr;
 merge corr acute_up6 chronic_up6 t1y_up6 t2y_up6 t3y_up6 t4y_up6 ct1y_up6 ct2y_up6 ct3y_up6 ct4y_up6 cs;
 by study;
run;
proc sort data=corr;
 by study eventnumber;
...
proc datasets nolist;
 delete acute chronic t1y t2y t3y t4y up6 temp1 temp2 acute_row chronic_row t1y_row
        t2y_row t3y_row t4y_row up6_row corr acute_up6 chronic_up6 t1y_up6 t2y_up6 t3y_up6 t4y_up6 cs
        ct1y ct2y ct3y ct4y ct1y_row ct2y_row ct3y_row ct4y_row ct1y_up6 ct2y_up6 ct3y_up6 ct4y_up6;
run;
quit;
%end;
data &out;
