...
run;
data cstudies;
 set pclean3.b_gfr_up_all_acr30 pclean3.b_gfr_up_6m_acr30 pclean3.b_gfr_up_12m_acr30;
...
run;
%zexportcsv(allcoxmodels4,txt_effects_endpoints2_acr30,&path1\analysis_acr\acr_exports);
data Exports.txt_effects_endpoints2_acr30;
 set allcoxmodels4;
run;
...
proc sort data=zallcoxmodels4;
 by datagrp2 dataset eventnumber zallrx;
run;
%zexportcsv(zallcoxmodels4,txt_effects_endpoints2a_acr30,&path1\analysis_acr\acr_exports);
