...
ods listing close;
options nonotes;
%eventstable(fda2_allrx,age,evxt1b,evxt1c,evxt1d,evxt1e);
%eventstable(fda2_allrx,delupro6,evxt1b6m,evxt1c6m,evxt1d6m,evxt1e6m);
%eventstable(fda2_allrx,delupro12,evxt1b12m,evxt1c12m,evxt1d12m,evxt1e12m);
