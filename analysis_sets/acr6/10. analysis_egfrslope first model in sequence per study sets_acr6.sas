...
libname results "&path1\analysis_sets\acr6\models\results";
libname temp "&path1\analysis_sets\acr6\models\temp";
libname temp2 "&path1\analysis_sets\acr6\models\temp2";
