...
data t99_trunc18;
 ...
 set t99_trunc182;
run;
data Exports.t99_trunc18;
 set t99_trunc18;
run;
%zexportcsv(t99_trunc18,t99_trunc18,&path1\analysis_sets\trunc18\Exports);

data SASdata.t99_trunc18;
 set t99_trunc18;
run;
%zexportcsv(t99_trunc18,t99_trunc18,&path1\analysis_sets\trunc18\Datasets);
