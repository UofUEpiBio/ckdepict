...
%zexportcsv(deltaupsummary292018,deltaupsummary,&path1\analysis_sets\acr6\exports);

%zexportcsv(deltaupsummary292018,deltaupsummary,&path1\analysis_sets\acr6\datasets);
