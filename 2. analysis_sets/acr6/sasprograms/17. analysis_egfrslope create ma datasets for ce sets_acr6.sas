...
run;
proc sort data=ce_t99_acr6_ma;
 by eventnumber zallrx;
run;
data SASdata.ce_t99_acr6_ma;
 set ce_t99_acr6_ma;
run;
%zexportcsv(ce_t99_acr6_ma,ce_t99_acr6_ma,&path1\analysis_sets\acr6\Datasets);

data Exports.ce_t99_acr6_ma;
 set ce_t99_acr6_ma;
run;
%zexportcsv(ce_t99_acr6_ma,ce_t99_acr6_ma,&path1\analysis_sets\acr6\Exports);
