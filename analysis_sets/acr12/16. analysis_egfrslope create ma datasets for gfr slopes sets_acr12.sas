...
proc sort data=txt01;
 by study;
run;
data slopes_t99_acr12_ma;
 merge slopes_t99_ma txt01;
 by study;
run;
proc sort data=slopes_t99_acr12_ma;
 by parameternumber zallrx;
run;
data SASdata.slopes_t99_acr12_ma;
 set slopes_t99_acr12_ma;
run;
%zexportcsv(slopes_t99_acr12_ma,slopes_t99_acr12_ma,&path1\analysis_sets\acr12\Datasets);

data Exports.slopes_t99_acr12_ma;
 set slopes_t99_acr12_ma;
run;
%zexportcsv(slopes_t99_acr12_ma,slopes_t99_acr12_ma,&path1\analysis_sets\acr12\Exports);