...
run;
data cstudies;
 set pclean3.b_gfr_up_6m pclean3.b_gfr_up_12m;
...
data sall2;
 ...
 drop var_order;
run;
%zexportcsv(sall2,txt_effects_up2,&path1\analysis_acr\acr_exports);
...
data zzsall2;
 ...
 drop var_order;
run;
%zexportcsv(zzsall2,txt_effects_up2a,&path1\analysis_acr\acr_exports);
/** No intercept **/
data prot_models2;
 set prot_models1;
run;
...
data xsall2;
 ...
 drop var_order;
run;
%zexportcsv(xsall2,noint_txt_effects_up2,&path1\analysis_acr\acr_exports);
