...
proc sort data=txt01;
 by study;
run;
data slopes_t99_trunc18_ma;
 merge slopes_t99_ma txt01;
 by study;
run;
proc sort data=slopes_t99_trunc18_ma;
 by parameternumber zallrx;
run;
data SASdata.slopes_t99_trunc18_ma;
 set slopes_t99_trunc18_ma;
run;
%zexportcsv(slopes_t99_trunc18_ma,slopes_t99_trunc18_ma,&path1\analysis_sets\trunc18\Datasets);

data Exports.slopes_t99_trunc18_ma;
 set slopes_t99_trunc18_ma;
run;
%zexportcsv(slopes_t99_trunc18_ma,slopes_t99_trunc18_ma,&path1\analysis_sets\trunc18\Exports);
