...
proc sort data=txt01;
 by study;
run;
data slopes_t99_acr6_ma;
 merge slopes_t99_ma txt01;
 by study;
run;
proc sort data=slopes_t99_acr6_ma;
 by parameternumber zallrx;
run;
data SASdata.slopes_t99_acr6_ma;
 set slopes_t99_acr6_ma;
run;
%zexportcsv(slopes_t99_acr6_ma,slopes_t99_acr6_ma,&path1\analysis_sets\acr6\Datasets);

data Exports.slopes_t99_acr6_ma;
 set slopes_t99_acr6_ma;
run;
%zexportcsv(slopes_t99_acr6_ma,slopes_t99_acr6_ma,&path1\analysis_sets\acr6\Exports);
