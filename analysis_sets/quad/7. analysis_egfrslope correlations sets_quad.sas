...
libname temp "&path1\analysis_sets\quad\correlations\temp";
libname temp2 "&path1\analysis_sets\quad\correlations\temp2";
...
_Log_ACR_=YES,_Acute_GFR_=YES,_QUAD_=YES,_TRUNC_=NO,_TRUNCATE_=27);
%doall(1);

*%zexportcsv(results.cor1,cor1,&path1\analysis_sets\quad);
