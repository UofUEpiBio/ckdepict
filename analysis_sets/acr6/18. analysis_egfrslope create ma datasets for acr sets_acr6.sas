...
data acr_t99_acr6_ma;
 set Exports.txt_effects_up2;
 if compress(variable)="T_assign" and compress(model)="2.ANCOVA";
run;
data SASdata.acr_t99_acr6_ma;
 set acr_t99_acr6_ma;
run;
%zexportcsv(acr_t99_acr6_ma,acr_t99_acr6_ma,&path1\analysis_sets\acr6\Datasets);

data Exports.acr_t99_acr6_ma;
 set acr_t99_acr6_ma;
run;
%zexportcsv(acr_t99_acr6_ma,acr_t99_acr6_ma,&path1\analysis_sets\acr6\Exports);
