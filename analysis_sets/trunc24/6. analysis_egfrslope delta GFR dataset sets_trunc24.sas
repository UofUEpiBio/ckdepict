...
data Exports.freqs_lsmeans;
 set freqs_lsmeans;
run;
%zexportxlsx(freqs_lsmeans,freqs_lsmeans,&path1\analysis_sets\trunc24\exports);
data Exports.missed_lsmeans;
 set missed_lsmeans;
run;
%zexportxlsx(missed_lsmeans,missed_lsmeans,&path1\analysis_sets\trunc24\exports);
