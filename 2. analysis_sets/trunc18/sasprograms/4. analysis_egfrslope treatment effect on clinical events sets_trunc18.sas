...
run;
%zexportcsv(allcoxmodels4,egfrslope_txteff_ce,&path1\analysis_sets\trunc18\exports);
...
run;
%zexportcsv(zzallcoxmodels4,egfrslope_txteff_ce1,&path1\analysis_sets\trunc18\exports);
/** data for MA in R **/
...
run;
%zexportcsv(egfrslope_txteff_ce_r,egfrslope_txteff_ce_r,&path1\analysis_sets\trunc18\exports);
