...
data t99_acr12;
 ...
 set t99_all2;
run;
data Exports.t99_acr12;
 set t99_acr12;
run;
%zexportcsv(t99_acr12,t99_acr12,&path1\analysis_sets\acr12\Exports);

data SASdata.t99_acr12;
 set t99_acr12;
run;
%zexportcsv(t99_acr12,t99_acr12,&path1\analysis_sets\acr12\Datasets);
