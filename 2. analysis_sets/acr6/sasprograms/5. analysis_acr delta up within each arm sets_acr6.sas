 ...
 *if datagrp2=1;
run;
data SASdata.deltaup_group;
 set deltaup_group;
 *if datagrp2=1;
run;
%zexportcsv(deltaup_group,deltaup_group,&path1\analysis_sets\acr6\exports);

%zexportcsv(deltaup_group,deltaup_group,&path1\analysis_sets\acr6\datasets);
