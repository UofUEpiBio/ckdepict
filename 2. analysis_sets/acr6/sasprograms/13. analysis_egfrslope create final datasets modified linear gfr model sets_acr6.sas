...
run;
%zexportcsv(xzall_models_t99,nfirstmodelinseqperstudyt99,&path1\analysis_sets\acr6\datasets);
data SASdata.nfirstmodelinseqperstudyt99;
 set xzall_models_t99;
run;
%zexportcsv(xzall_models_t99,nfirstmodelinseqperstudyt99,&path1\analysis_sets\acr6\exports);
