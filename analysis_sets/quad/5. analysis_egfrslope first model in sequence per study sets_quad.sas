...
libname temp "&path1\analysis_sets\quad\models\temp";
libname temp2 "&path1\analysis_sets\quad\models\temp2";
...
_Log_ACR_=NO,_Acute_GFR_=NO,_QUAD_=YES,_TRUNC_=NO,_TRUNCATE_=27);
%doall(1);
