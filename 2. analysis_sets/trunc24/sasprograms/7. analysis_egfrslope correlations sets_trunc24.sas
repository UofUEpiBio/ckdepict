...
libname temp "&path1\analysis_sets\trunc24\correlations\temp";
libname temp2 "&path1\analysis_sets\trunc24\correlations\temp2";
...
_Log_ACR_=YES,_Acute_GFR_=YES,_QUAD_=NO,_TRUNC_=YES,_TRUNCATE_=27);
%doall(1);
