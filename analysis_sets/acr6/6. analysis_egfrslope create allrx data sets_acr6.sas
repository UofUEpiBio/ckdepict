...
data Exports.allrxdata;
 set allrxdata;
run;
%zexportcsv(allrxdata,allrxdata,&path1\analysis_sets\acr6\datasets);
%zexportcsv(allrxdata,allrxdata,&path1\analysis_sets\acr6\exports);
...
data Exports.zallrxdata;
 set zallrxdata;
run;
%zexportcsv(zallrxdata,zallrxdata,&path1\analysis_sets\acr6\datasets);
%zexportcsv(zallrxdata,zallrxdata,&path1\analysis_sets\acr6\exports);
