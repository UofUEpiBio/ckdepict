...
run;
proc sort data=ce_t99_quad_ma;
 by eventnumber zallrx;
run;
data SASdata.ce_t99_quad_ma;
 set ce_t99_quad_ma;
run;
%zexportcsv(ce_t99_quad_ma,ce_t99_quad_ma,&path1\analysis_sets\quad\Datasets);

data Exports.ce_t99_quad_ma;
 set ce_t99_quad_ma;
run;
%zexportcsv(ce_t99_quad_ma,ce_t99_quad_ma,&path1\analysis_sets\quad\Exports);
