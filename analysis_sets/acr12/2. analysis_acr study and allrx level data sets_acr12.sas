...
proc sort data=allrxstudy;
 by allrx;
run;
data allrxstudy_acr12;
 length allrx 8. allrxname $17.
        study_num 8. studyname $17.;
 set allrxstudy;
run;
data SASdata.allrxstudy_acr12;
 set allrxstudy;
run;
data Exports.allrxstudy_acr12;
 set allrxstudy;
run;
%zexportcsv(allrxstudy_acr12,allrxstudy_acr12,&path1\analysis_sets\acr12\datasets);
%zexportcsv(allrxstudy_acr12,allrxstudy_acr12,&path1\analysis_sets\acr12\exports);
...
data allrxdata_acr12;
 ...
 set allrxdata;
run;
data SASdata.allrxdata_acr12;
 set allrxdata_acr12;
run;
data Exports.allrxdata_acr12;
 set allrxdata_acr12;
run;
%zexportcsv(allrxdata_acr12,allrxdata_acr12,&path1\analysis_sets\acr12\datasets);
%zexportcsv(allrxdata_acr12,allrxdata_acr12,&path1\analysis_sets\acr12\exports);
...
proc sort data=zallrxdata;
 by zallrx;
run;
data zallrxdata_acr12;
 length allrx zallrx 8. allrxname1 $18. study_code $5.;
 set zallrxdata;
run;
data SASdata.zallrxdata_acr12;
 set zallrxdata_acr12;
run;
data Exports.zallrxdata_acr12;
 set zallrxdata_acr12;
run;
%zexportcsv(zallrxdata_acr12,zallrxdata_acr12,&path1\analysis_sets\acr12\datasets);
%zexportcsv(zallrxdata_acr12,zallrxdata_acr12,&path1\analysis_sets\acr12\exports);
...
length  dataused 8. datausedname $15. 
 ...
 set b_gfr_up_12m;
run;
data SASdata.b_gfr_up_12m;
 set b_gfr_up_12m;
run;
data Exports.b_gfr_up_12m;
 set b_gfr_up_12m;
run;
%zexportcsv(b_gfr_up_12m,b_gfr_up_12m,&path1\analysis_sets\acr12\datasets);
%zexportcsv(b_gfr_up_12m,b_gfr_up_12m,&path1\analysis_sets\acr12\exports);
...
run; 
data SASdata.studydata_acr12;
 set studydata_acr12;
run;
data Exports.studydata_acr12;
 set studydata_acr12;
run;
%zexportcsv(studydata_acr12,studydata_acr12,&path1\analysis_sets\acr12\datasets);
%zexportcsv(studydata_acr12,studydata_acr12,&path1\analysis_sets\acr12\exports);
