...
%futimes(505,0+1+3+6+12+18+24,1.5,25.5);
...
data Exports.freqs_lsmeans;
 set freqs_lsmeans;
run;
%zexportxlsx(freqs_lsmeans,freqs_lsmeans,&path1\analysis_egfrslope\&t.\&t._exports);
data Exports.missed_lsmeans;
 set missed_lsmeans;
run;
%zexportxlsx(missed_lsmeans,missed_lsmeans,&path1\analysis_egfrslope\&t.\&t._exports);
